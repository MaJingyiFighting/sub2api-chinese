  ...
  admin: {
    ...
    accounts: {
      ...
      codingPlan: {
        ...
        providerHint: 'Kimi、智谱、MiniMax、火山配额查询已支持；MiMo 仍是实验性配额探测，不保证自动暂停/恢复准确。',
        ...
        mimo: '小米 MiMo',
        domesticTab: '国内模型',
        dualAccountHint: '只需输入一次 API Key 与 Base URL。系统会自动创建两个账号：Chat/Codex（承接 Codex /v1/responses）与 Claude Code（承接 /v1/messages）。',
        ...
        anthropicSameBaseNote: '该供应商无法自动推导 Anthropic endpoint，已暂时复用同一基础地址。如果 Anthropic endpoint 不同，可在创建后编辑高级地址。',
        chatOnlyNote: '该供应商不支持 Anthropic Messages，当前仅创建 Codex/Chat 账号。',
        baseUrlHint: '供应商基础地址。Anthropic 变体地址会按供应商预设自动推导。',
        ...
        quotaBaseUrl: '配额查询基础地址',
        quotaBaseUrlPlaceholder: '留空使用默认官方 OpenAPI 地址',
        quotaBaseUrlHint: '仅在你有私有网关或代理时填写；火山默认使用 ark.<region>.volces.com。',
