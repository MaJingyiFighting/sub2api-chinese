  ...
  admin: {
    ...
    accounts: {
      ...
      codingPlan: {
        ...
        providerHint: 'Kimi, Zhipu, and MiniMax support active quota queries. Volcengine and MiMo use error-driven scheduling by default.',
        ...
        experimentalProbeUrlHint: 'Only fill this after you have verified the endpoint. Leave empty to show unsupported.',
