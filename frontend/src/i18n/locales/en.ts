  ...
  admin: {
    ...
    accounts: {
      ...
      codingPlan: {
        ...
        providerHint: 'Kimi, Zhipu, MiniMax, and Volcengine quota queries are supported. MiMo quota probes are still experimental and may not pause or recover accounts accurately.',
        ...
        dualAccountHint: 'Enter the API key and base URL once. Two accounts are created automatically: Chat/Codex (serves Codex /v1/responses) and Claude Code (serves /v1/messages).',
        ...
        anthropicSameBaseNote: 'The Anthropic endpoint cannot be derived for this provider, so the same base URL is reused for now. If the Anthropic endpoint differs, edit the advanced URL after creation.',
        chatOnlyNote: 'This provider does not support Anthropic Messages; only the Codex/Chat account will be created.',
        baseUrlHint: 'Provider base URL. The Anthropic variant URL is derived from the provider preset.',
        ...
        quotaBaseUrl: 'Quota base URL',
        quotaBaseUrlPlaceholder: 'Leave empty to use the official OpenAPI endpoint',
        quotaBaseUrlHint: 'Only fill this for a private gateway or proxy. Volcengine defaults to ark.<region>.volces.com.',
