  ...
  admin: {
    ...
    accounts: {
      ...
      codingPlan: {
        ...
        providerHint: 'Kimi, Zhipu, and MiniMax can use built-in quota probes. Volcengine and MiMo probes are experimental. DeepSeek and custom compatible providers recover passively from 429/401/5xx.',
        ...
        dualAccountHint: 'Enter the API key and base URL once. Accounts are created only for the provider capabilities that are actually configured: Chat/Codex for Codex /v1/responses and/or Claude Code for /v1/messages.',
        dualAccountCreated: 'Created both the Chat/Codex and Claude Code accounts.',
        chatOnlyCreated: 'Created the Chat/Codex account. This provider has no Anthropic Messages endpoint, so the Claude Code account was not created.',
        anthropicSameBaseNote: 'The Anthropic endpoint cannot be derived for this provider, so the Chat base URL is not reused by default.',
        anthropicExplicitOnlyNote: 'This provider will not reuse the Chat base URL for Anthropic. A Claude Code account is created only when an Anthropic base URL is entered.',
        anthropicOnlyNote: 'This entry creates only an Anthropic Messages account for Claude Code /v1/messages.',
        chatOnlyNote: 'This provider does not support Anthropic Messages; only the Codex/Chat account will be created.',
        baseUrlHint: 'Provider base URL. Kimi/Zhipu can use preset Anthropic URLs; MiniMax/MiMo require an explicit Anthropic base URL.',
        anthropicBaseUrl: 'Anthropic base URL (optional)',
        anthropicBaseUrlPlaceholder: 'Example: https://example.com/anthropic',
        anthropicBaseUrlHint: 'Fill this only when the provider really exposes an Anthropic Messages endpoint. Empty means no Claude Code account is created.',
        baseUrlRequiredPlaceholder: 'Required: enter this provider\'s upstream base URL',
        apiFormat: 'API format',
        apiFormatHint: 'Chat Completions uses the OpenAI-compatible API. Anthropic Messages only handles Claude Code style /v1/messages.',
        quotaBaseUrl: 'Experimental quota base URL (read-only)',
        quotaBaseUrlPlaceholder: 'No custom experimental probe URL is set',
        quotaBaseUrlHint: 'Shows an existing experimental probe URL from legacy or debug accounts. The frontend no longer creates or edits this field.',
        baseUrlRequired: 'Please enter the upstream base URL for this platform.',
        volcengineOpenAPI: 'Volcengine OpenAPI quota query',
        volcengineOpenAPIHint: 'Model calls still use the ark API key. Quota queries require Volcengine Access Key ID / Secret Access Key. Without AK/SK the account can still call models, but cannot auto-query real plan quota.',
        volcenginePlanType: 'Plan type',
        volcengineCodingPlan: 'Coding Plan',
        volcengineAgentPlan: 'Agent Plan',
        volcengineRegion: 'Region',
        volcengineAccessKeyId: 'Access Key ID',
        volcengineSecretAccessKey: 'Secret Access Key',
        volcengineSeatId: 'Seat ID',
        volcengineAccountId: 'Account ID (optional)',
        volcengineProjectName: 'Project Name (optional)',
